...
<?php
// lúc này $query chứa tập hợp dữ liệu trả về cần dùng vòng lặp để đọc dl theo từng dong
...
<td><a href="them.php">Thêm</a>/<a href='sua.php?id=<?php echo $row ['STT']?>'>Sửa</a>/<a href= 'xoa.php?id=<?php echo $row ['STT']?>'>Xóa</a> </td>
</tr>
<?php
    }
}
